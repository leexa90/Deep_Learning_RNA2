...
for i in data2:
   data2[i][0] = data2[i][0]*0
   data2[i][1] = data2[i][1]*0

for i in data2_t:
   data2_t[i][0] = data2_t[i][0]*0
   data2_t[i][1] = data2_t[i][1]*0
            ...
            try:
                ...
                for window_tup in [(35,11),(50,13),(75,25),(100,33),(125,41),(150,50),(200,66),(300,100),(400,133),(500,167)]:
                    ...
                    for repeat in range(0,len(data1[i][0]) - window+1,jump):
                        #if np.mean(d0[repeat:repeat+window,repeat:repeat+window,:]) > 0.95: 
