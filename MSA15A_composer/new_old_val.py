...
data2 = np.load('../data_lim5000_ss_composer.npy.zip')['data_lim5000_ss_composer'].item()
data3 = np.load('../data_lim5000_extra_composer.npy').item()
data4 = np.load('../data_lim5000_MSA_composer.npy').item()

data1_t = np.load('../data_lim5000_nan_composer.npy.zip')['data_lim5000_nan_composer.npy'].item()
data2_t = np.load('../data_lim5000_ss_composer.npy.zip')['data_lim5000_ss_composer'].item()
data3_t = np.load('../data_lim5000_extra_composer.npy').item()
data4_t = np.load('../data_lim5000_MSA_composer.npy').item()
